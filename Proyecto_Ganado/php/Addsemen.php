...
<head>
    ...
    <title>Agregar Muestra de Semen</title>
...
<div class="content">
    <div class="login-container">
        ...
        <form action="Addsemen.php" method="POST">
            <input type="text" class="input-field" name="Codigo" placeholder="Código" required><br>
            <input type="text" class="input-field" name="Nombre_donador" placeholder="Nombre del Donante" required><br>
            <input type="date" class="input-field" name="fecha_compra" placeholder="Fecha de Compra" required><br>
            <input type="number" class="input-field" name="cantidad" placeholder="Cantidad" required><br>
            <input type="text" class="input-field" name="Tipo" placeholder="Tipo" required><br>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $Nombre_donante = trim($_POST['Nombre_donador']);
    ...
    if (empty($Codigo) || empty($Nombre_donante) || empty($cantidad)) {
        echo "<script>alert('Error: Los campos Código, Nombre del donante y Cantidad son obligatorios'); window.history.back();</script>";
        exit();
    }
